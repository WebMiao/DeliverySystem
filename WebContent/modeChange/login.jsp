...
<form method="post" action="/DeliverySystem/idcheck" id = "log">
	...
	<div style="margin:0 auto;font-size:15px;width:300px">Not a user?<a href="./loginS.jsp"> SELLER</a></div>
	<div style="margin:0 auto;font-size:15px;width:300px">Do not have a account?<a href="./signupU.jsp"> REGISTER</a></div>
